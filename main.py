...
KEYWORD_RESPONSES = {
    ...
    "пральня": "🧺 Пральня — 710",
    "кухня": "🍳 Кухня — 722",
    "бар": "🍹 Бар — зверніться до рецепції (701)",
    ...
    "фітнес": "💪 Фітнес — уточнюйте на рецепції (701)",
    "wifi": "📶 Wi-Fi для персоналу: напишіть /wifi",
    "wi-fi": "📶 Wi-Fi для персоналу: напишіть /wifi",
    "телефони": "📞 Всі внутрішні телефони: напишіть /contacts",

    # 🔑 коди доступу (ключові слова, якщо захочеш)
    "корпус в": '🔑 Корпус "В" — 4141',
    "корпус с": '🔑 Корпус "С" — 4141',
    "вхід для персоналу": "🔑 Вхід для персоналу — 4444",
}
...
STARTUP_MESSAGE = (
    "⚠️ Бот був офлайн.\n"
    "Якщо під час цього вийшов новий графік відключень — "
    "перевірте канал pat_cherkasyoblenergo."
)
